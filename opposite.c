...
/* A directory of the letters A-Z (indexed as A=0...Z=25) as 6x6 images. The binary
...
int main(int argc, char *argv[]) {
    if (argc == 2) {
        ...
        char *word = argv[1];
        for (i = 0; word[i] != '\0'; i++) {
            /* Will only take in letters a-z, A-Z, or a space. Changes each letter to its
             * uppercase form for a uniform string. */
    ...
    printf("Needs 1 argument: string.\n");
    return 1;
}
